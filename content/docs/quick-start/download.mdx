...
### Web Version
- Access via web browser (no download required)
- Connect to your qBittorrent instance remotely

For more details on pricing and what's included in the lifetime license, please see our [Pricing Details](pricing).