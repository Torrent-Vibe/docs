...
This FAQ covers the most common questions and issues users encounter with Torrent Vibe. If you can't find an answer here, check the [Troubleshooting](../troubleshooting/) section or contact support.
...
**Torrent Vibe offers a free trial with full features**, allowing you to try all functionality without restrictions. After the trial period, you can purchase a lifetime license for permanent access to all features.

- **Free Trial**: Full-featured trial, no credit card required
- **Lifetime License**: $9.99 one-time payment for permanent access
...
See [Installation Guide](../quick-start/installation) for detailed instructions.
...
See [Connecting to qBittorrent](../quick-start/connecting-qbittorrent) for detailed troubleshooting.
...
See [Adding Torrents](../user-guide/torrent-management/adding-torrents) for complete instructions.
...
See [Search](../user-guide/organization/search) for detailed search syntax.
...
See [Multi-Server Setup](../advanced/multi-server/setup) for configuration.
...
See [Speed Monitoring](../user-guide/monitoring/speed-monitoring) for detailed analysis.
...
See [Bandwidth Control](../user-guide/monitoring/bandwidth-control) for advanced optimization.
...
See [Automation](../advanced/automation/rss-feeds) for setup.
...
See [RSS Feeds](../advanced/automation/rss-feeds) for detailed setup.
...
See [Connection Problems](../troubleshooting/common-issues/connection-problems) for detailed troubleshooting.
...
See [API Reference](../developer/api-reference/rest-api) for details.
...
- **Manual download**: [Download from GitHub](https://github.com/Torrent-Vibe/Torrent-Vibe/releases)
- **Package manager**: If installed via package manager
...
2. **Community forums**: User community discussions
3. **GitHub issues**: Report bugs and request features
4. **Email support**: Direct support for licensed users
5. **Live chat**: Real-time assistance (premium)
...
**Torrent Vibe offers a simple, transparent pricing model:**

- **Free Trial**: Full-featured trial with no restrictions or credit card required
- **Lifetime License**: $9.99 one-time payment for permanent access to all features

**No subscriptions, no recurring fees** - purchase once and use forever.

### Can I use Torrent Vibe commercially?

**Yes**, the Lifetime License includes commercial use rights. The $9.99 license covers:
...
**Simple 3-step purchase process:**

1. **Download Free Trial**: [Start Free Trial](https://github.com/Torrent-Vibe/Torrent-Vibe/releases)
2. **Purchase Lifetime License**: [Buy Lifetime Access - $9.99](https://www.creem.io/payment/prod_3MvxEew9LAj3kofPW6vqia)
3. **Receive License Key**: License key sent instantly to your email
4. **Activate**: Enter the license key in the application

**Secure payment processing** via Creem - your payment information is never stored on our servers.
...
See [General Settings](../user-guide/preferences/general-settings) for backup configuration.

---

**Still have questions?** Check the [Troubleshooting](../troubleshooting/) section or contact our support team.