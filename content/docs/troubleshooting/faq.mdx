...
**Yes**, Torrent Vibe is free and open-source. However, some advanced features may require a premium license for commercial use.
...
- **Manual download**: Download from website
...
- **Personal**: Enhanced features, single user
- **Professional**: All features, commercial use
- **Enterprise**: Advanced features, multiple users

See [Licensing](../purchase/licensing) for details.

### Can I use Torrent Vibe commercially?

**Commercial use:**
- Requires appropriate license
- Professional or Enterprise license needed
- Contact sales for custom pricing
- Support included with commercial licenses

### How do I purchase a license?

1. **Visit website**: Go to torrent-vibe.app/pricing
2. **Choose plan**: Select appropriate license
3. **Complete purchase**: Secure payment processing
4. **Receive license**: License key sent via email
5. **Activate license**: Enter key in application
