...
Torrent Vibe supports multiple methods for adding torrents, including files, magnet links, and drag-and-drop functionality.
...
2. Choose your preferred method:
   - **From File**: Select a .torrent file from your computer
   - **From Magnet Link**: Paste a magnet URI

![Add Torrent Dialog](/screenshots/TorrentVibeScreenshot_AddTorrentDialog.png)

### Drag and Drop

Simply drag .torrent files or magnet links directly onto the Torrent Vibe window.

### Magnet Link Support

Paste magnet links in the following format:
```
